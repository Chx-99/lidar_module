...
// 获取ack中data字段
inline std::span<const uint8_t> get_data_field_span(const uint8_t *data, size_t size)
{
...
// 通过set与id解析对应指令类型
constexpr std::string_view get_ack_name_compile_time(uint8_t cmd_set, uint8_t cmd_id)
{
...
public:
    ...
    template <typename T>
    friend inline std::ostream &operator<<(std::ostream &os, Frame<T> &frame);
};
template <typename T>
inline std::ostream &operator<<(std::ostream &os, Frame<T> &frame)
{
...
struct BoardCast
{
    ...
    inline friend std::ostream &operator<<(std::ostream &os, BoardCast &boardcast)
    {
        std::ostringstream oss;
...
struct HandShake
{
    ...
    explicit HandShake(std::string local_ip, uint16_t data_port,
    ...
    inline friend std::ostream &operator<<(std::ostream &os, HandShake &handshake)
    {
        std::ostringstream oss;
        oss << std::hex << std::uppercase << std::setfill('0');
        oss << "cmd_set: 0x" << static_cast<int>(handshake.cmd_set) << "\n";
        oss << "cmd_id: 0x" << static_cast<int>(handshake.cmd_id) << "\n";
        oss << "user_ip: " << std::dec << handshake.user_ip[0] << "."
            << handshake.user_ip[1] << "."
            << handshake.user_ip[2] << "."
            << handshake.user_ip[3] << "\n";
...
struct HandShakeACK
{
    ...
    inline friend std::ostream &operator<<(std::ostream &os, HandShakeACK &ack)
    {
        std::ostringstream oss;
        oss << std::hex << std::uppercase << std::setfill('0');
...
struct HeartBeat
{
    ...
    inline friend std::ostream &operator<<(std::ostream &os, HeartBeat &ack)
    {
        std::ostringstream oss;
        oss << std::hex << std::uppercase << std::setfill('0');
        oss << "cmd_set: 0x" << static_cast<int>(ack.cmd_set) << "\n";
...
struct HeartBeatACK
{
    ...
    inline friend std::ostream &operator<<(std::ostream &os, HeartBeatACK &ack)
    {
        std::ostringstream oss;
        oss << std::hex << std::uppercase << std::setfill('0');
        oss << "cmd_set: 0x" << static_cast<int>(ack.cmd_set) << "\n";
...
struct SetLaserStatus
{
    ...
    inline friend std::ostream &operator<<(std::ostream &os, SetLaserStatus &ack)
    {
        std::ostringstream oss;
        oss << std::hex << std::uppercase << std::setfill('0');
        oss << "cmd_set: 0x" << static_cast<int>(ack.cmd_set) << "\n";
...
struct SetLaserStatusACK
{
    ...
    inline friend std::ostream &operator<<(std::ostream &os, SetLaserStatusACK &ack)
    {
        std::ostringstream oss;
        oss << std::hex << std::uppercase << std::setfill('0');
        oss << "cmd_set: 0x" << static_cast<int>(ack.cmd_set) << "\n";
...
struct set_imu_frequency_ack
{
    ...
    inline friend std::ostream &operator<<(std::ostream &os, set_imu_frequency_ack &msg)
    {
        std::ostringstream oss;
        oss << std::hex << std::uppercase << std::setfill('0');
        oss << "cmd_set: 0x" << static_cast<int>(msg.cmd_set) << "\n";
...
struct dataFrame
{
    ...
    // 序列化输出 重载<<
    inline friend std::ostream &operator<<(std::ostream &os, dataFrame &frame)
    {
